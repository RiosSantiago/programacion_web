          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button className="relative w-10 h-10 flex items-center justify-center rounded-xl text-white/70 hover:text-white hover:bg-white/10 transition-all duration-200">
                ...
                <span className="absolute -top-0.5 -right-0.5 w-4.5 h-4.5 bg-[#D9A441] text-[#1F4D36] text-[9px] font-bold rounded-full flex items-center justify-center">0</span>
              </button>
              ...
              <button className="relative w-10 h-10 flex items-center justify-center rounded-xl text-white/70 hover:text-white hover:bg-white/10 transition-all duration-200">
                ...
                <span className="absolute -top-0.5 -right-0.5 w-4.5 h-4.5 bg-emerald-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center">3</span>
              </button>

              {/* Avatar */}
              <div className="w-9 h-9 ml-1 bg-gradient-to-br from-[#D9A441] to-[#B8860B] rounded-xl flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-[#D9A441]/20 cursor-pointer hover:scale-105 transition-transform duration-200">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {menuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-80 bg-gradient-to-b from-[#1F4D36] to-[#132D1A] shadow-2xl z-50 lg:hidden overflow-y-auto"
            >
