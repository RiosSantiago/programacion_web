...
export default function TraceabilityBlock({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
      <div className="px-5 py-4 bg-gradient-to-r from-campo-50 to-white border-b border-slate-100 flex items-center justify-between">
      ...
      <div className="p-5 space-y-5">
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-slate-50 rounded-xl p-4 text-center">
            <p className="text-2xl font-extrabold text-campo-600">{data?.pesoActual || 445} kg</p>
