...
-- Índice único parcial: permite múltiples NULL en google_id (usuarios normales)
...
-- ---------------------------------------------------------------------------
-- ÍNDICES DE ALTO RENDIMIENTO (tablas de alta consulta)
-- Mantener sincronizado con database/migrations/011_indexes.sql
-- ---------------------------------------------------------------------------
